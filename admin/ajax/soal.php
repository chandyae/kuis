...
<div class="row">              
      <div class="col-sm-12 text-center">
		  ...
		  <strong>Aturan Main : </strong> Soal dan jawaban akan tampil secara acak. setiap jawaban benar maka anda mendapat point +10 dan setiap jawaban salah anda mendapat point -5. 
		  <!-- <br><small>*Swipe ke bawah untuk Memulai kembali kuis.*</small> -->
		</div>

		<h2>Selamat</h2>
		<h1>Score Anda : <div id="nilai">0</div></h1>
		<h2>Silahkan mengambil hadiah yang sudah disediakan</h2>
