...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img alt="Brand" src="../assets/img/quiz1.png" width="30"></a>
        ...
        <div class="jumbotron">
          <div id="kontenku">
              <div class="row">
                  ...
                  <div class="col-sm-12">
                    <img src="../assets/img/quiz1.png" alt="../assets/img/quiz1.png" class="img img-responsive imgku">
                  </div>
                  <div class="col-sm-12 text-center">
                    <h2>Selamat Datang di Kuis Pameran Hasil Karya Guru <?= $_SESSION["user"]; ?> </h2>
                    <p>Aplikasi ini adalah salah satu media pembelajaran yang digunakan oleh guru</p>
                    <p><a class="btn btn-primary btn-lg" onclick="mulai()" href="#" role="button">Mulai Kuis</a></p>
                  </div>
      ...
      <div class="footer">
        <p>&copy;<span id="tahun"></span> Pameran Hasil Karya Pakisaji</p>
        <script>
